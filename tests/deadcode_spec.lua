...
t.test('and the manifest lists every Lua file that exists', function()
    ...
    local found = io.popen('ls ../Crimson-Arena/client/*.lua ../Crimson-Arena/server/*.lua ../Crimson-Arena/shared/*.lua ../Crimson-Arena/shared/compat/*.lua ../Crimson-Arena/config.lua 2>/dev/null')
