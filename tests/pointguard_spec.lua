...
local FILES = {
    '../Crimson-Arena/shared/arena.lua', '../Crimson-Arena/shared/compat/dispatch.lua',
    '../Crimson-Arena/server/main.lua', '../Crimson-Arena/server/match.lua', '../Crimson-Arena/server/lobby.lua',
    '../Crimson-Arena/server/ammo.lua', '../Crimson-Arena/server/betting.lua', '../Crimson-Arena/server/dispatch.lua',
    '../Crimson-Arena/server/stats.lua', '../Crimson-Arena/server/util.lua',
    '../Crimson-Arena/client/main.lua', '../Crimson-Arena/client/match.lua', '../Crimson-Arena/client/spectate.lua',
    '../Crimson-Arena/client/ui.lua', '../Crimson-Arena/client/dispatch.lua',
}
...
t.test('and Arena.IsPoint itself still admits the vector types', function()
    ...
    -- goes on passing.
    local code = codeOf('../Crimson-Arena/shared/arena.lua')
...
t.test('and the server can still be asked where a player is', function()
    ...
    local code = codeOf('../Crimson-Arena/server/match.lua')
